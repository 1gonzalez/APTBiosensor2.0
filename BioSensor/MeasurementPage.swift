                        ...
                        List {
                            ForEach(fetchRequest) { item in
                                NavigationLink {
                                    ...
                                    HStack{
                                        Text((item.dateTime ?? Date.now).formatted()).foregroundColor(Color(red: 0.13, green: 0.63, blue: 0.85))
                                        Spacer()
                                        Text("\(item.pitch,format: .number.precision(.fractionLength(2)))°").foregroundColor(Color(red: 0.13, green: 0.63, blue: 0.85))
                                        Spacer()
